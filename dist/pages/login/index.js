...
__webpack_require__(/*! ./index.less */ "./src/pages/login/index.less");
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.tobegin = function () {
      var jsCode = void 0;
      _taroWeapp2.default.login().then(function (loginInfo) {
        ...
        var _userInfo$userInfo = userInfo.userInfo,
            ...
            gender = _userInfo$userInfo.gender,
            language = _userInfo$userInfo.language,
            city = _userInfo$userInfo.city,
            province = _userInfo$userInfo.province,
            country = _userInfo$userInfo.country,
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = ["tobegin"], _class.$$componentPath = "pages/login/index", _temp2);
...
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/laya/Documents/GitWorkSpace/wxAuthLogin/wxAuthLogin/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/login/index.jsx?taro&type=template&parse=PAGE& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
